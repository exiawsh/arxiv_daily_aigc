...
def main(target_date: date):
    ...
    if os.path.exists(json_filepath):
        ...
        filtered_papers = filter_papers_by_topic(raw_papers, topic="long video generation, video generation, camera control, motion control, world model, streaming generation")
